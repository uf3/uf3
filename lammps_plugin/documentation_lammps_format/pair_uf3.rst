...
.. code-block:: LAMMPS
    ...
    pair_coeff 1 * Nb_Nb
    pair_coeff 2 * Sn_Sn
    pair_style 1 1 1 * * Nb_Sn_Sn
    pair_style 1 1 2 * * Sn_Sn_Sn
...
The UF3 LAMMPS potential files are provided using single pair_coeff commands. 
