...
class BSplineBasis_with_magnetism(BSplineBasis):
    def __init__(self,
        ...
        self.magnetic_chemical_system = magnetic_chemical_system
        super().__init__(chemical_system=magnetic_chemical_system,
                         r_min_map=r_min_map,
                         r_max_map=r_max_map,
    ...
    def from_dict(config):
        ...
        magentic_chemical_system = composition.MagChemicalSystem.from_dict(config)
        ...
        bspline_config_with_magnetism = BSplineBasis_with_magnetism(magnetic_chemical_system, **basis_settings)
    ...
    @property
    def degree(self):
        return self.magnetic_chemical_system.degree

    @property
    def element_list(self):
        return self.magnetic_chemical_system.element_list

    @property
    def interactions_map(self):
        return self.magnetic_chemical_system.interactions_map

    @property
    def interactions(self):
        return self.magnetic_chemical_system.interactions
    
    @property
    def magnetic_interactions(self):
        return self.magnetic_chemical_system.magnetic_interactions
    ...
    def __repr__(self):
        ...
        summary.append(self.magnetic_chemical_system.__repr__())
        return "\n".join(summary)
    ...
    def modify_feature_partition_sizes(self):
        ...
        interactions = self.magnetic_chemical_system.interactions_map["Magnetic_interaction"]
        for interaction in interactions:
